...
export default function DashboardPage() {
    ...
    const fetchData = async () => {
        try {
            const endpoint = activeTab === 'plans' ? 'http://localhost:3002/api/v1/admin/plans' : 'http://localhost:3002/api/v1/admin/ads';
    ...
    const handleDelete = async (id: string) => {
        ...
        try {
            await axios.delete(`http://localhost:3002/api/v1/admin/${activeTab}/${id}`, {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post(`http://localhost:3002/api/v1/admin/${activeTab}`, payload, {
                headers: { Authorization: `Bearer ${token}` }
            });
            setIsFormOpen(false);
            setFormData({});
